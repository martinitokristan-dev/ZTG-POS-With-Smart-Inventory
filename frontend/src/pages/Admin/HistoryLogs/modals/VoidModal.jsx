            ...
            <div className="modal-card" style={{ maxWidth: '520px', width: '95%', background: 'var(--bg-card)', borderRadius: '12px', overflow: 'hidden', boxShadow: 'var(--shadow-lg)', border: '1px solid var(--border)' }}>
                <form onSubmit={handleSubmit}>
                    <div className="modal-header" style={{ position: 'relative', background: 'var(--danger-light)', borderBottom: '1px solid rgba(239,68,68,0.2)', padding: '20px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', gap: '8px' }}>
                        ...
                        <div>
                            <h3 style={{ color: 'var(--danger)', fontSize: '18px', fontWeight: '700', margin: '0 0 2px 0', fontFamily: '"Outfit", sans-serif' }}>
                                Void Transaction
                            </h3>
                            <p style={{ color: 'var(--text-secondary)', fontSize: '12px', margin: 0 }}>Admin authorization required — Cashier must physically request this action</p>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div style={{ background: 'var(--bg-secondary)', border: '1px solid var(--border)', borderRadius: '10px', padding: '16px', display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px 24px' }}>
                                ...
                                <div>
                                    ...
                                    <span style={{ fontWeight: '600', color: 'var(--text-primary)', fontSize: '13.5px' }}>{transaction.checker?.name || transaction.cashier?.name || '—'}</span>
                                </div>
